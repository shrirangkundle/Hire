...
function CandidateRegistration(props) {
    ...
    const submitHandler = (data) => {
        if(data){
            ...
            formData["userRole"]="HIRING MANAGER"
            WebUtils.httpOperations(AppAPIs["REGISTER_USER"], formData, "POST").then(res => {
                if(res.data && res.data.resultStatusInfo && res.data.resultStatusInfo.resultCode == "SUCCESS") {
                    setMessage(<div style={{textAlign:"center"}}><Icon type="green-tick"/> Registration Completed,  Varification email  sent to {data.email} Successfully. </div>)
                ...
                setMessage(<div style={{textAlign:"center"}}>{"Registration Failed."}</div>)
    ...
    return (
        ...
        <div className="left-section">
            ...
            <div className="image-wrapper" role={"HIRING MANAGER"}></div>
