...
function RegistrationPage(props) {
    ...
    let config = {
        ...
        _order: {firstName:1,lastName: 2,contactNumber: 3, email: 4,password: 5,confirm_password: 6,userRole: 7,submit: 8},
        firstName:{
            type:"text",
            label:"First Name",
            key:"firstName",
        ...
        <div className="left-section">
            ...
            <div className="text-wrapper">
                ...
                <div className="title-5">
                    IT Team here. Quickly.
                </div>
                <div className="sub-title">
                    Save Wasted Effort, Costs and Time.
                </div>
                <div className="secondary-title-4">
                    Apply for account credentials & sign-up for a 60 Day         
                </div>
                <div className="secondary-title-5">
                    no-cost no-commitment trial for your Org.          
                </div>
                <div className="secondary-title-6">
